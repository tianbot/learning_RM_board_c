...
环境搭建推荐大家日常使用比较方便的设备。例如，我们在机器人开发中常用的 Ubuntu 系统的 ROS2GO 设备或者 mini PC设备。如果常用的开发设备是 Windows 系统的话，我推荐大家按照文档结尾的 Windows 系统下 GCC + OpenOCD + VSCode 的环境进行搭建。
...
这个是权限问题。也就是openocd没有权限看到、操作调试器。
...
2. [Openocd xPack下载](https://github.com/xpack-dev-tools/openocd-xpack/releases)
    ...
    下载 xpack-openocd-0.12.0-1-**win32-x64.zip** ，随便解压到你认识的地方，接下来的步骤与上面相同
